...
* You would need to import all the libraries used in the notebook. All the libraries used are listed in the Mask_and_Age_Classification_.ipynb file.
...
## Trained Model
* We used transfer learning and used few pre-trained architectures implemented in Keras. The best models had accuracy results of around 98% and were based on ResNet50 and ResNet152 pre-trained architectures. Below is a link to the best model and summary table of results and important parameters used at training.
